...
void task_config_service(void) {
    ...
    lora_message_t *msg = lora_get_received_data();
    ParsedCommand cmd = parse_command(msg->data, msg->length);
    ...
    case CMD_SET_PID: {
        ...
        case 4:
            ...
            break;
        default:
            lora_send_string_nb(1, "ERR:BAD_AXIS");
            return;
        }
    ...
    case CMD_SET_MOTOR_BIAS:
        ...
        lora_send_string_nb(1, "ACK:BIAS");
        break;
    ...
    case CMD_CONFIG:
        ...
        lora_send_string_nb(1, "ACK:CONFIG");
        break;
    ...
    case CMD_CALIBRATE:
        if (!IS_ARMED(fc_state)) {
            ...
            toggle_led();
            lora_send_string_nb(1, "ACK:CALIBRATE");
        }
        break;
